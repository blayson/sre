...
psql -U postgres mta -f "/tmp/db/import_user_roles.sql"
psql -U postgres mta -f "/tmp/db/import_reviews_suggestions_states.sql"
psql -U postgres mta -f "/tmp/db/add_reviews_final_state.sql"
psql -U postgres mta -f "/tmp/db/import_final_states.sql"
psql -U postgres mta -f "/tmp/db/20221220_update_suggestions.sql"
